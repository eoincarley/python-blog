...
trace0 = go.Scatter(x=times, y=total, line = {'width':2}, marker={'color': colors[0], 'symbol': 100, 'size': "10"}, 
       mode="markers+lines", text=['Total'], name='Total')

trace1 = go.Scatter(x=times, y=age0, line = {'width':2}, marker={'color': colors[1], 'symbol': 100, 'size': "10"}, 
         mode="markers+lines", text=['18-24 yrs old'], name='18-24 yrs')

trace2 = go.Scatter(x=times, y=age1, line = {'width':2}, marker={'color': colors[2], 'symbol': 100, 'size': "10"}, 
       mode="markers+lines", text=['25-44 yrs old'], name='25-44 yrs')

trace3 = go.Scatter(x=times, y=age2, line = {'width':2}, marker={'color': colors[3], 'symbol': 100, 'size': "10"}, 
       mode="markers+lines", text=['45-65 yrs old'], name='45-65 yrs')

trace4 = go.Scatter(x=times, y=age3, line = {'width':2}, marker={'color': colors[4], 'symbol': 100, 'size': "10"}, 
       mode="markers+lines", text=['65+ yrs old'], name='65+ yrs')
...
py.iplot(fig, filename='Ireland-Homeless-Plot0')
